...
plt.plot(xv,densityv,'peru',lw=2.0, label=r'$\sigma_{LL} = 3.2 \AA, \epsilon_{LL}= 2.6 kJ/mol,\sigma_{LS} = 3.3 \AA, \epsilon_{LS}= 4$ kJ/mol')
...
plt.savefig('density_run1_1.png', format='png',dpi=300, bbox_inches='tight')
plt.show()
